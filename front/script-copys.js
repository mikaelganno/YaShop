let listHTML = document.querySelector('.tbody');
...
const addData = () => {
    ...
    if(listProduct.length > 0){
        listProduct.forEach(products => {
            let newProducts = document.createElement('tr');
            newProducts.classList.add('tr');
                    ...
                    <tr>
                        <td>
                            <div class="product-img">
                                <div class="img-prdct">
                                    <img src="assets/products/${products.image}" alt="">
                                </div>
                            </div>
                        </td>
                        <td class="nom">
                            <p>${products.name}</p>
                            <p>color: ${products.color1}</p>
                            <p>size: ${products.size1}</p>
                        </td>
                        <td>
                        ...
                        <td>
                            <span>$<div class="prix">${products.price}</div></span>
                        </td>
                        <td align="right">$<span class="amounts" id="amounts">0</span></td>
                        <td><i class="ri-android-line"></i></td>
                    </tr>
                </tbody>
            `;
            listHTML.appendChild(newProducts);
        })
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            <div class="content">
                                    ...
                                    <div class="variant">
                                        <form action="">
                                            <p>
                                                ...
                                                <label for="${product.colors1}" id="colors" class="circle"></label>
                                            </p>
                                            <p>
                                                <input type="radio" name="color" id="coblue">
                                                <label for="${product.colors2}" id="colors" class="circle"></label>
                                            </p>
                                            <p>
                                                <input type="radio" name="color" id="cogreen">
                                                <label for="${product.colors3}"id="colors"  class="circle"></label>
                                            </p>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="actions">
                                    <div class="qty-control flexitem">
                                        ...
                                        <input type="text" class="val" value="1" min="1">
